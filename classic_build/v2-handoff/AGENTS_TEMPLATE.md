...
- Preferências do Classic devem passar por repositório tipado e versionado; não reproduza diretamente as chaves de `localStorage` do V8.
- Eventos de domínio não devem depender de `CustomEvent`; cada plataforma usa um adaptador sobre contratos compartilhados.
