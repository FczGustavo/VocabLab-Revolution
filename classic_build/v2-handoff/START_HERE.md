...
## Estado da auditoria — 8 ago 2026

- **[Confirmado]** `vitest run`: 11 arquivos, 43 testes, todos aprovados.
...
- **[Problema conhecido crítico]** A sincronização multiwriter existe no código, mas continua quebrada no uso real. Ela não é uma referência confiável de comportamento nem um critério de paridade para o Classic; apenas seus objetivos, formatos exportáveis e casos de conflito podem ser reaproveitados.

## Estimativa de tokens

Uma conversa nova que carregue apenas este `START_HERE.md` consome aproximadamente 1.500–2.000 tokens, dependendo do tokenizer. Para iniciar qualquer tarefa de implementação, os documentos requeridos totalizam:
