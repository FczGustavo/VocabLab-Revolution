...
- **Spike de sincronização**: Provar outbox, cursor do servidor, tombstones e convergência com dois clientes descartáveis antes de conectar o motor aos Labs. Não reutilizar o cliente quebrado do V8.
...
- **Motor de Estudo (Study Engine)**: Implementar inicialmente os 3 fluxos visíveis do V8 (flip, multiple choice e active recall), cálculo de streaks e gatilho de Review. No V8, Active Recall abre `WritingMode` e persiste `mode: "writing"`; o Classic deve unificar esse nome antes de criar um quarto modo distinto.
