...
```json
{
  ...
  "databases": {
    ...
    "rulelab-db": { "cards": [], "folders": [], "theoryDocuments": [], "meta": [] },
  ...
  "syncTombstones": {
    "vocab": [ { "id": "operation:flashcards:id:card-1:1769000000000", "storeName": "flashcards", "entityId": "card-1", "deletedAt": 1769000000000 } ],
    "regency": [],
    "rule": [],
    "read": [],
    "question": []
