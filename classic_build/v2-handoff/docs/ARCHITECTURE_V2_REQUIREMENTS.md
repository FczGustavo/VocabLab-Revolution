...
## Restrição motivada pelo V8

**[Redesenhar]** A sincronização atual está quebrada no uso real. O Classic não deve reutilizar `auto-sync-client.ts` como fundação. Pode reaproveitar casos de conflito e formatos de importação como fixtures, mas precisa de protocolo, backend, observabilidade e testes E2E novos.
